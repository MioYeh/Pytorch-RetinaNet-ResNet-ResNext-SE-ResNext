...
# TCGA/Test_Label/'
# old_data_distribution/old_T_V_T/Test_Labels/'
# original_path = '/home/mio861225tw/VGH_DATASET/old_data_distribution/old_T_V_T/Test_Images/'
# TCGA/Test_Image/'
# old_data_distribution/old_T_V_T/Test_Images/'
...
#         O_image = cv2.imread(os.path.join(original_path, img_name))
...
#             print('Elapsed time: {}'.format(time.time() - st))
            ...
            for j in range(idxs[0].shape[0]):
                ...
                if max(score_iou) >= 0.5:
                    ...
                    array_FP += 1
                    MaP_FP += 1
                MaP_FN = MaP_Label-MaP_TP
                print(img_name, iou, caption, interArea)
#             print('MaP_TP, MaP_FP', MaP_Label, MaP_TP, MaP_FP, MaP_FN)
